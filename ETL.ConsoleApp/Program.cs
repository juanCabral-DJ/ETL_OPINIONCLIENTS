...
namespace ETL_Clientes
{
    internal class program
    {
        static void Main(string[] args)
        {
            ...
            string connectionString = "Server=MSI;Database=Analisis_OpinionessETL;Integrated Security=True;TrustServerCertificate=True";
            ...
            var reviews = TransformCSV.TransformReviews(reviewss);
            ...
            var surveys = TransformCSV.TransformSurveys(surveyse);
            ...
            var comments = TransformCSV.TransformComments(commentss);
            ...
            dbLoader.LoadData(surveys, comments, clientes, productos, reviews, fuenteDatos);
